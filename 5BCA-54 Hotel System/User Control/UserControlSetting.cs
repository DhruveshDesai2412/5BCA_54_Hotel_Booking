    ...
    public partial class UserControlSetting : UserControl
    {
        ...
        private void buttonUpdate_Click(object sender, EventArgs e)
        {
            ...
            if(ID != "")
            {
                ...
                MessageBox.Show("Please first select row table.", "Selection of row.", MessageBoxButtons.OK, MessageBoxIcon.Information);
        }
        ...
        private void buttonDelete_Click(object sender, EventArgs e)
        {
            ...
            if (ID != "")
            {
                ...
                {
                    DialogResult result = MessageBox.Show("Are you want to delet this user?", "User delete", MessageBoxButtons.YesNo, MessageBoxIcon.Question);
        ...
        {
          db.DisplayAndSearch("SELECT * FROM User_Name LIKE '%" + textBoxSearchUsername.Text + "%'", dataGridViewUser);
        }
    }
}
