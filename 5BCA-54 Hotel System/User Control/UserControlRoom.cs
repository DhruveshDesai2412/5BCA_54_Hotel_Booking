...
namespace _5BCA_54_Hotel_System.User_Control
{
    ...
    public partial class UserControlRoom : UserControl
    {
        ...
        {
            db.DisplayAndSearch("SELECT * FROM dbo.Room_Table", dataGridViewRoom);
        ...
        private void buttonDelete_Click(object sender, EventArgs e)
        {
            ...
            if (No != "")
            {
                ...
                {
                    DialogResult result = MessageBox.Show("Are you want to delet this room?", "Room delete", MessageBoxButtons.YesNo, MessageBoxIcon.Question);
